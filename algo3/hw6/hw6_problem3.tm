...
<\body>
  ...
  <\enumerate-numeric>
    ...
    <\enumerate-alpha>
      ...
      and suppose <math|y<rsub|1>=0,y<rsub|2>=2>, then
      ...
      If <math|h<rsub|p<rsub|1>,p<rsub|2>><around|(|x<rsub|1>,x<rsub|2>|)>=h<rsub|p<rsub|1>,p<rsub|2>><around|(|y<rsub|1>,y<rsub|2>|)>=0>
      then
      ...
      <\equation*>
        h<rsub|p<rsub|1>,0><around|(|0,0|)>=h<rsub|p<rsub|1>,0><around|(|0,2|)>
        and h<rsub|p<rsub|1>,<frac|m|2>><around|(|0,0|)>=h<rsub|p<rsub|1>,<frac|m|2>><around|(|0,2|)>,p<rsub|1>\<in\><around|[|m|]>
      </equation*>

      Since for pair <math|x<rsub|1>=0>, <math|x<rsub|2>=0> and
      <math|y<rsub|1>=0>, <math|y<rsub|2>=2>, <math|<around|\||P|\|>=2m>,
      <math|<frac|<around|\||P|\|>|m>=2> out of the
      <math|<around|\||P|\|>=m<rsup|2>> parameter pairs
    ...
    <math|<around|(|x<rprime|'><rsub|1>, x<rprime|'><rsub|2>|)>> that hash to
    the same value. Describe how to find further inputs that collide.\ 
    ...
    <\with|font-base-size|8>
      <\eqnarray*>
        ...
        mod m<htab|5mm><around*|(|k\<in\>Z<rsup|\<star\>>|)>>>|<row|<cell|<around*|(|p<rsub|1><around*|(|x<rsub|1>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)>|)>+p<rsub|2><around*|(|x<rsub|2>+k<around*|(|x<rsub|2>-x<rsub|2><rprime|'>|)>|)>|)>
        mod m>|<cell|=>|<cell|<around*|(|p<rsub|1>x<rsub|1>+p<rsub|2>x<rsub|2>|)>
    ...
    <\with|font-base-size|8>
      <\eqnarray*>
        <tformat|<table|<row|<cell|<tabular|<tformat|<table|<row|<cell|h<rsub|p<rsub|1>,p<rsub|2>><around*|(|x<rsub|1><rprime|'>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)>\<nocomma\>\<nocomma\>,x<rsub|2><rprime|'>+k<around*|(|x<rsub|2>-x<rsub|2><rprime|'>|)>|)>>>>>>>|<cell|=>|<cell|h<rsub|p<rsub|1>,p<rsub|2>><around*|(|x<rsub|1><rprime|'>,x<rsub|2><rprime|'>|)><htab|5mm><around*|(|k\<in\>Z<rsup|\<star\>>|)>>>>>
      </eqnarray*>
    </with>
    ...
    <\with|font-base-size|8>
      <\eqnarray*>
        <tformat|<table|<row|<cell|x<rsub|1><rprime|''>>|<cell|=>|<cell|x<rsub|1>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)>>>|<row|<cell|x<rsub|2><rprime|''>>|<cell|=>|<cell|x<rsub|2>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)><htab|5mm><around*|(|k\<in\>Z<rsup|\<star\>>|)>>>>>
      </eqnarray*>
    </with>
    ...
    <with|font-base-size|8|<\eqnarray*>
      <tformat|<table|<row|<cell|x<rsub|1><rprime|''>>|<cell|=>|<cell|x<rsub|1><rprime|'>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)>>>|<row|<cell|x<rsub|2><rprime|''>>|<cell|=>|<cell|x<rsub|2><rprime|'>+k<around*|(|x<rsub|1>-x<rsub|1><rprime|'>|)><htab|5mm><around*|(|k\<in\>Z<rsup|\<star\>>|)>>>>>
    </eqnarray*>>
