 ...
 *                {@linkplain https://leetcode.com/problems/number-of-islands-ii/}
 *
 */
public class uf_count_islands_filling_sea
{
    class Point
    {
        int x;
    ...
    private List<Point> getNeighbor(Point p, Point[][] leaders)
    {
        ...
        for (int[] d : dir) {
            ...
            if (nx < 0 || nx >= n || ny < 0 || ny >= m || leaders[nx][ny] == null) {
                continue;
            }

            result.add(leaders[nx][ny]);
        }
