...
public class math_nt_count_trailing_zero_in_n_factorial
{
     ...
     * number 1 to n. 10 could be multiplied by 2 and 5, also because there will
     * be an even number every 2 numbers, the task becomes counting how many
     * number of 5 in all factors of n!.
     *
     */
