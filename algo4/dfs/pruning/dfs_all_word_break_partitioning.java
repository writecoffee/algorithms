 ...
 *
 */
public class dfs_all_word_break_partitioning {
    ...
    private void explore(String s, int end, Set<String> dict, Stack<String> path, ArrayList<String> result, boolean[] isBreak) {
        if (end < 0) {
        ...
        for (int i = end; i >= 0; --i) {
            ...
            if (dict.contains(t)) {
                path.push(t);
                explore(s, i - 1, dict, path, result, isBreak);
                path.pop();
            }
        }
    }
